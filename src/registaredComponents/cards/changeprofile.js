...
const ChangeProfile = (props)=>{
            ...
            image.onload = function() {
              if (this.width > 0) {
                ...
                if(url.length > 20000){
                    ...
                    axios.post('http://localhost:5000/updateImage',{id : localStorage.getItem('ID'), url : url })
                    .then(response=>{
    ...
    return <Fragment>
        {ReactDOM.createPortal(<Overlay onClick={closeHandler} change = {props.change}  />, overlayId)}
