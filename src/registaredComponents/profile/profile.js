  ...
  return (
    <Fragment>
      ...
      <div className={classes.card}>
        ...
        <br />
        <button onClick={() => setChange(!change)} className={classes.button}>
          change my information
        </button>
        <br />
        <button
          onClick={() => setChangeProfile(!changeProfile)}
          className={classes.buttonChangeProfile}
        >
          change profile picture
        </button>
        <br />
        <button onClick={deleteAcountHandler} className={classes.button1}>
          delete my account
        </button>
      </div>
    </Fragment>
